Sub Stock_Summary()
    ...
    For Each Current In Worksheets
        ...
        Loop
    'MsgBox Current.Name
    Summary_of_Summary Current
    Next
End Sub

Sub Summary_of_Summary(Current)
    ...
    Do Until IsEmpty(Current.Cells(Row, 11))
        ...
        If Current.Cells(Row, 12).Value > Greatest_Total_Vol Then
            ...
            Greatest_Total_Vol_Ticker = Current.Cells(Row, 9).Value
        End If
    ...
    Current.Cells(4, 17).NumberFormat = "0.0000E+00"
    Current.Cells(4, 16).Value = Greatest_Total_Vol_Ticker
End Sub
